...
std::string secret = skCrypt("secret").decrypt(); // Application secret 
...
std::string url = skCrypt("https://keyauth.site/api/1.2/").decrypt(); // change if using KeyAuth custom domains feature
