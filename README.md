...
KeyAuth C++ example SDK for https://keyauth.site license key API auth.
...
This is common amongst all authentication systems. Program obfuscation causes false positives in virus scanners, and with the scale of KeyAuth this is perceived as a malicious domain. So, `keyauth.site`  have been blocked by many internet providers. for dashbord, reseller panel, customer panel, use `keyauth.site`
...
Visit https://keyauth.site/app/ and select your application, then click on the **C++** tab
...
std::string url = "https://keyauth.site/api/1.2/"; // change if you're self-hosting
